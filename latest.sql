...
--
-- Table structure for table `cp_holidays`
--

DROP TABLE IF EXISTS `cp_holidays`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cp_holidays` (
  `id` int NOT NULL AUTO_INCREMENT,
  `clinic_user_id` int NOT NULL,
  `title` varchar(255) NOT NULL,
  `holiday_date` date NOT NULL,
  `day` varchar(20) NOT NULL,
  `status` enum('upcoming','completed','inactive') DEFAULT 'upcoming',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Dumping data for table `cp_holidays`
--

LOCK TABLES `cp_holidays` WRITE;
/*!40000 ALTER TABLE `cp_holidays` DISABLE KEYS */;
INSERT INTO `cp_holidays` VALUES (1,8,'New Year','2026-01-01','Thursday','completed','2025-09-15 18:22:23','2025-09-15 18:43:56'),(2,8,'Diwali','2025-09-20','Saturday','upcoming','2025-09-15 18:41:10','2025-09-15 18:41:10');
/*!40000 ALTER TABLE `cp_holidays` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `doctor_schedule_days` (
  ...
  CONSTRAINT `doctor_schedule_days_ibfk_1` FOREIGN KEY (`schedule_id`) REFERENCES `doctor_schedules` (`id`) ON DELETE CASCADE
...
INSERT INTO `doctor_schedule_days` VALUES (3,26,'Mon','04:01:00','11:01:00',NULL,NULL),(4,26,'Sat','07:01:00','14:01:00',NULL,NULL);
...
CREATE TABLE `doctor_schedules` (
  ...
  `schedule_type` enum('fixed','variable') NOT NULL DEFAULT 'fixed',
  `status` enum('active','inactive') DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `doctor_schedules` VALUES (16,8,15,1,'Mon,Sun','23:42:00','00:42:00','07:42:00','08:42:00',15,'fixed','active','2025-09-02 15:13:05','2025-09-07 08:47:39'),(17,5,19,3,'Mon','01:44:00','04:44:00','13:44:00',NULL,5,'fixed','active','2025-09-02 15:14:15','2025-09-07 07:28:26'),(18,8,9,7,'Mon,Tue','22:44:00','23:44:00','01:44:00','02:44:00',5,'fixed','active','2025-09-02 15:14:54','2025-09-02 15:14:54'),(21,8,22,8,'Mon,Tue','14:17:00','15:17:00','21:18:00','23:18:00',15,'fixed','active','2025-09-07 08:48:21','2025-09-07 08:48:21'),(25,8,7,1,'Mon,Tue','23:52:00','00:52:00','02:52:00','04:52:00',15,'fixed','active','2025-09-16 17:22:58','2025-09-16 17:22:58'),(26,8,23,11,'',NULL,NULL,NULL,NULL,20,'variable','active','2025-09-16 17:32:03','2025-09-17 16:18:01');
...
INSERT INTO `prescription_medicines` VALUES (12,4,'Paracetamol','2','2','after food'),(13,4,'Dolo 650','2','2','after food'),(43,6,'Paracetamol','3','4','Take 2 times'),(44,6,'dolo','3','4','after food'),(45,6,'ins','1','2','after food'),(49,5,'Paracetamol','2','5','after food'),(51,7,'Paracetamol','3','6','after food'),(52,8,'dlo','1','2','after food');
...
INSERT INTO `prescription_templates` VALUES (3,8,'Demo','template_3.php','#00ffe5','#7a7a7a','#0080ff','#000000','#ff0000','1757700592_logo1.png','1757792394_images (1).png',0.10,'2025-09-12 18:08:36'),(4,9,'Futurious Template',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1.00,'2025-09-14 16:38:16'),(5,5,'Demo Prescription','template_5.php','#009688','#004d40','#212529','#000000','#444444',NULL,NULL,1.00,'2025-09-15 15:41:51');
...
INSERT INTO `prescriptions` VALUES (4,8,10,9,'3',NULL,NULL,'Take the medicines properly and connect me after test complete','2025-09-15','2025-09-13 16:58:57',NULL),(5,8,1,25,'template-2',NULL,NULL,'SDRFG','2025-09-18','2025-09-13 17:54:41','2025-09-13 20:02:50'),(6,8,10,23,'3',NULL,NULL,'Addeeddwytfuiwopeiuydfghjkoploiuytrewrtyuirzxfcgshdjkvkldgbyevhijowp2eofbvh cddlwdugvyufhjewnlrfgyvhkel;obvoribv ','2025-09-20','2025-09-13 18:06:31','2025-09-13 19:28:13'),(7,5,9,18,'template-4',NULL,NULL,'added','2025-09-16','2025-09-15 15:48:39','2025-09-15 15:49:02'),(8,8,1,23,'template-2',NULL,NULL,'wertyuikl','2025-09-18','2025-09-15 16:05:34',NULL);
...
-- Dump completed on 2025-09-19 20:02:04
